/*  =========================================================================
    aisnmea_selftest.c - run selftests
...
// Tests for draft public classes:
    { "aisnmea", aisnmea_test },
#endif // AISNMEA_BUILD_DRAFT_API
#ifdef AISNMEA_BUILD_DRAFT_API
    { "private_classes", aisnmea_private_selftest },
#endif // AISNMEA_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running aisnmea selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
...
main (int argc, char **argv)
{
    ...
    for (argn = 1; argn < argc; argn++) {
        ...
        ||  streq (argv [argn], "-h")) {
            puts ("aisnmea_selftest.c [options] ...");
